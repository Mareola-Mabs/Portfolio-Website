! function(e) {
    "use strict";
    async function t(t) {
        t && dsnGrid.executeStyle(), await dsnGrid.destoryBuild(), await a("poster"), await a("src"), await a("srcset"), await a("bg"), await void e("[data-dsn-position]").each((function() {
            ...
            t.validator(), t.off("submit"), t.on("submit", (function(n) {
                if (!n.isDefaultPrevented()) return e.ajax({
                    ...
                    success: function(e) {
                        var n = "alert-" + e.type,
                            i = e.message,
                            a = '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Submitted Successfully, You will be contacted shortly' + i + "</div>";
